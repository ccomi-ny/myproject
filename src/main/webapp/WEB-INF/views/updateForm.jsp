...
<body>
	...
	<input type="hidden" name="rno" value="${edit.rno}">
		<p>아이디: ${edit.rid}
		<p>비밀번호: <input type="password" name="rpasswd" value="${edit.rname}">
		...
		<p>연락처: <select name="rtel1">
				...
				-<input type="text" name="rtel3" size="4" value="${edit.rtel.substring(9)}">
		...
		<p><textarea name="rprofile" rows="3" cols="30">${edit.rprofile}</textarea>
